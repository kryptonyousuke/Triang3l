<h1 align="center">
	<img src=".assets/icon.png" style="width: 100px; margin-inline: auto; position: absolute; top: 0px; left: calc(50% - 50px);">
	<p style="margin-top: 120px; font-size: 2rem; font-weight: bold;">Triang3l</p>
	<p style="font-size: 2rem; font-weight: bold;">Light-weight discord bot to share punishments across different servers.</p>
	<img alt="time since the last commit" src="https://img.shields.io/github/last-commit/kryptonyousuke/Anihub?style=for-the-badge&logo=git&color=red">
	<img alt="stars count" src="https://img.shields.io/github/stars/kryptonyousuke/Triang3l?style=for-the-badge&logo=starship&labelColor=941fd3&color=white">
	<img alt="licenses" src="https://img.shields.io/badge/license-ISC-blue.svg?style=for-the-badge&logo=mdbook&logoColor=ffffff&labelColor=1fd37f&color=grey">
	...
	<img alt="application banner" src=".assets/banner.png">
</h1>
